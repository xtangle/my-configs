...
1. (Optional) To enable Pi-hole to list names instead of IPs of devices on a LAN assuming DHCP server is enabled on the router, you will have to enable conditional forwarding:
